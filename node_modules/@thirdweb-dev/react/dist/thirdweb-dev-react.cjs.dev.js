...
var CHAIN_ID_TO_GNOSIS_SERVER_URL = (_CHAIN_ID_TO_GNOSIS_S = {}, _defineProperty(_CHAIN_ID_TO_GNOSIS_S, browser.ChainId.Mainnet, "https://safe-transaction.mainnet.gnosis.io"), _defineProperty(_CHAIN_ID_TO_GNOSIS_S, browser.ChainId.Avalanche, "https://safe-transaction.avalanche.gnosis.io"), _defineProperty(_CHAIN_ID_TO_GNOSIS_S, browser.ChainId.Polygon, "https://safe-transaction.polygon.gnosis.io"), _defineProperty(_CHAIN_ID_TO_GNOSIS_S, browser.ChainId.Goerli, "https://safe-transaction.goerli.gnosis.io"), _defineProperty(_CHAIN_ID_TO_GNOSIS_S, browser.ChainId.Rinkeby, "https://safe-transaction.rinkeby.gnosis.io"), _CHAIN_ID_TO_GNOSIS_S);

var __IS_SERVER__$1 = typeof window === "undefined";
...
var GnosisSafeConnector = /*#__PURE__*/function (_Connector) {
  ...
  _createClass(GnosisSafeConnector, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                _context2.next = 16;
                return Promise.all([Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@gnosis.pm/safe-ethers-adapters')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@gnosis.pm/safe-core-sdk')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@gnosis.pm/safe-ethers-lib')); })]);
    ...
    value: function onChainChanged(chainId) {
      var id = wagmi.normalizeChainId(chainId);
...
var __IS_SERVER__ = typeof window === "undefined";
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('magic-sdk')); }).then( /*#__PURE__*/function () {
...
var chain = {
  mainnet: {
    id: browser.ChainId.Mainnet,
    name: "Ethereum Mainnet",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Mainnet],
  ...
  rinkeby: {
    id: browser.ChainId.Rinkeby,
    name: "Rinkeby",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Rinkeby],
  ...
  goerli: {
    id: browser.ChainId.Goerli,
    name: "Goerli",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Goerli],
  ...
  polygonMainnet: {
    id: browser.ChainId.Polygon,
    name: "Polygon Mainnet",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Polygon],
  ...
  polygonTestnetMumbai: {
    id: browser.ChainId.Mumbai,
    name: "Mumbai",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Mumbai],
  ...
  avalanche: {
    id: browser.ChainId.Avalanche,
    name: "Avalanche",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Avalanche],
  ...
  avalancheFujiTestnet: {
    id: browser.ChainId.AvalancheFujiTestnet,
    name: "Avalanche Fuji Testnet",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.AvalancheFujiTestnet],
  ...
  fantom: {
    id: browser.ChainId.Fantom,
    name: "Fantom Opera",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Fantom],
  ...
  fantomTestnet: {
    id: browser.ChainId.FantomTestnet,
    name: "Fantom Testnet",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.FantomTestnet],
  ...
  optimism: {
    id: browser.ChainId.Optimism,
    name: "Optimism",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Optimism],
  ...
  optimismTestnet: {
    id: browser.ChainId.OptimismTestnet,
    name: "Optimism Kovan",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.OptimismTestnet],
  ...
  arbitrum: {
    id: browser.ChainId.Arbitrum,
    name: "Arbitrum One",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.Arbitrum],
  ...
  arbitrumTestnet: {
    id: browser.ChainId.ArbitrumTestnet,
    name: "Arbitrum Rinkeby",
    nativeCurrency: sdk.NATIVE_TOKENS[browser.ChainId.ArbitrumTestnet],
...
var ThirdwebAuthConfigContext = /*#__PURE__*/React.createContext(undefined);
var ThirdwebAuthConfigProvider = function ThirdwebAuthConfigProvider(_ref) {
  var value = _ref.value,
      children = _ref.children;
  // Remove trailing slash from URL if present
  var authConfig = React.useMemo(function () {
...
var defaultChainRpc = (_defaultChainRpc = {}, _defineProperty(_defaultChainRpc, browser.ChainId.Mainnet, "mainnet"), _defineProperty(_defaultChainRpc, browser.ChainId.Rinkeby, "rinkeby"), _defineProperty(_defaultChainRpc, browser.ChainId.Goerli, "goerli"), _defineProperty(_defaultChainRpc, browser.ChainId.Polygon, "polygon"), _defineProperty(_defaultChainRpc, browser.ChainId.Mumbai, "mumbai"), _defineProperty(_defaultChainRpc, browser.ChainId.Fantom, "fantom"), _defineProperty(_defaultChainRpc, browser.ChainId.Avalanche, "avalanche"), _defaultChainRpc);
var ThirdwebConfigContext = /*#__PURE__*/React.createContext({
...
function useSigner() {
  ...
  var _useWagmiSigner = wagmi.useSigner(),
  ...
  var _useNetwork = wagmi.useNetwork(),
      _useNetwork2 = _slicedToArray(_useNetwork, 1),
      network = _useNetwork2[0];

  var _getSignerPromise = React.useRef(null);
...
var ThirdwebProvider = function ThirdwebProvider(_ref) {
  ...
  var _supporrtedChains = React.useMemo(function () {
  ...
  var _rpcUrlMap = React.useMemo(function () {
    return _supporrtedChains.reduce(function (prev, curr) {
      prev[curr.id] = curr.id in chainRpc ? browser.getProviderForNetwork(chainRpc[curr.id] || curr.rpcUrls[0]) : curr.rpcUrls[0];
      return prev;
    }, {});
  }, [chainRpc, _supporrtedChains]);

  var wagmiProps = React.useMemo(function () {
  ...
  var readonlySettings = React.useMemo(function () {
    ...
    try {
      rpcUrl = browser.getProviderForNetwork(rpcUrl);
    } catch (e) {
  ...
  var sdkOptionsWithDefaults = React.useMemo(function () {
    var opts = sdkOptions;
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ThirdwebConfigProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(wagmi.WagmiProvider, _objectSpread2(_objectSpread2({}, wagmiProps), {}, {
...
var ThirdwebSDKProviderWagmiWrapper = function ThirdwebSDKProviderWagmiWrapper(_ref3) {
  ...
  var provider = wagmi.useProvider();
  var signer = useSigner();
  return /*#__PURE__*/jsxRuntime.jsx(ThirdwebSDKProvider, _objectSpread2(_objectSpread2({
    signer: signer,
    provider: provider
  }, props), {}, {
    children: children
...
var ThirdwebSDKContext = /*#__PURE__*/React.createContext({
  desiredChainId: -1
});
...
var ThirdwebSDKProvider = function ThirdwebSDKProvider(_ref4) {
  ...
  var queryClientWithDefault = React.useMemo(function () {
    return queryClient ? queryClient : new reactQuery.QueryClient();
  }, [queryClient]);
  var sdk = React.useMemo(function () {
    if (!desiredChainId || typeof window === "undefined") {
      return undefined;
    }

    var _sdk = new browser.ThirdwebSDK(provider, sdkOptions, storageInterface);
...
function useSDKContext() {
  var ctx = React__default["default"].useContext(ThirdwebSDKContext);
...
function createContractCacheKey() {
  var contractAddress = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ethers.constants.AddressZero;
...
function useUser() {
  ...
  var _useQuery = reactQuery.useQuery(cacheKeys.auth.user(), /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
function useReadonlySDK(readonlyRpcUrl, sdkOptions, storageInterface) {
  return React.useMemo(function () {
    return new browser.ThirdwebSDK(readonlyRpcUrl, _objectSpread2(_objectSpread2({}, sdkOptions), {}, {
...
function useMetamask() {
  ...
  var isMetaMaskInjected = typeof window !== "undefined" && ((_window$ethereum = window.ethereum) === null || _window$ethereum === void 0 ? void 0 : _window$ethereum.isMetaMask);
...
function getContractAbi(input) {
  ...
  if (input.contractType !== "custom") {
    contractAbi = browser.CONTRACTS_MAP[input.contractType].contractAbi;
  }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            if (!(contract instanceof browser.SmartContract)) {
              _context2.next = 6;
              break;
            }
...
function useContractCall(contract, functionName) {
  ...
  var contractAddress = contract === null || contract === void 0 ? void 0 : contract.getAddress();
  var queryClient = reactQuery.useQueryClient();
  return reactQuery.useMutation( /*#__PURE__*/function () {
...
function useAllContractEvents(contract) {
  ...
  var queryClient = reactQuery.useQueryClient();
  var activeChainId = useActiveChainId();
  var cacheKey = React.useMemo(function () {
  ...
  return reactQuery.useQuery(cacheKey, function () {
    invariant__default["default"](contract, "contract must be defined");
...
function convertResponseToNFTType(contract, metadata) {
  if (contract instanceof browser.Erc721) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return contract.get(ethers.BigNumber.from(tokenId || 0));
...
function useTotalCount(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.query.totalCount(contractAddress), function () {
    ...
    if (contract instanceof browser.Erc721) {
      ...
      invariant__default["default"](contract === null || contract === void 0 ? void 0 : (_contract$query4 = contract.query) === null || _contract$query4 === void 0 ? void 0 : _contract$query4.totalCirculatingSupply, "Contract instance does not support query.totalCirculatingSupply");
      return contract.query.totalCirculatingSupply();
    }

    invariant__default["default"]((_contract$query5 = contract.query) === null || _contract$query5 === void 0 ? void 0 : _contract$query5.totalCount, "Contract instance does not support query.totalCount");
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            invariant__default["default"]((_contract$query6 = contract.query) === null || _contract$query6 === void 0 ? void 0 : (_contract$query6$owne = _contract$query6.owned) === null || _contract$query6$owne === void 0 ? void 0 : _contract$query6$owne.all, "Contract instance does not support query.owned.all");
          ...
          case 9:
            invariant__default["default"]((_contract$query7 = contract.query) === null || _contract$query7 === void 0 ? void 0 : _contract$query7.owned, "Contract instance does not support query.owned");
...
function useNFTBalance() {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.balanceOf(contractAddress, ownerWalletAddress, tokenId), function () {
    ...
    if (contract instanceof browser.Erc1155) {
      invariant__default["default"](tokenId, "No tokenId provided");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return contract.auction.getWinner(ethers.BigNumber.from(listingId || 0));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              if (!(data.type === browser.ListingType.Direct)) {
                _context5.next = 6;
                break;
              }
...
function useActiveClaimCondition() {
  ...
  return useQueryWithNetwork(cacheKeys.extensions.claimConditions.getActive(contractAddress, tokenId), function () {
    ...
    enabled: contract instanceof browser.Erc1155 ? tokenId !== undefined : !!contract
  });
}
/**
...
function useClaimIneligibilityReasons() {
  ...
  return useQueryWithNetwork(cacheKeys.extensions.claimConditions.getClaimIneligibilityReasons(contractAddress, params, tokenId), function () {
    ...
    enabled: (contract instanceof browser.Erc1155 ? tokenId !== undefined : !!contract) && !!params && !!params.walletAddress
  });
}
/** **********************/
...
function useResetClaimConditions() {
  ...
  var contractAddress = contract === null || contract === void 0 ? void 0 : contract.getAddress();
  var queryClient = reactQuery.useQueryClient();
  return reactQuery.useMutation( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
...
function useBalance(tokenAddress) {
  ...
  var signer = useSigner();
  var walletAddress = useAddress();
  var walletSDK = React.useMemo(function () {
    if (signer) {
      var rpcUrl = rpcUrlMap[chainId];
      return new browser.UserWallet(signer, {
...
function useUpdatePrimarySaleRecipient(contract) {
  ...
  var contractAddress = contract === null || contract === void 0 ? void 0 : contract.getAddress();
  var activeChainId = useActiveChainId();
  return reactQuery.useMutation(function (newRecipient) {
    invariant__default["default"](contract, "No contract provided");
    invariant__default["default"]("sales" in contract && contract.sales, "Contract does not support primarySale");
...
function useUpdateRoyaltySettings(contract) {
  ...
  var contractAddress = contract === null || contract === void 0 ? void 0 : contract.getAddress();
  var activeChainId = useActiveChainId();
  return reactQuery.useMutation(function (updatePayload) {
    invariant__default["default"](contract, "No contract provided");
    invariant__default["default"]("royalties" in contract && contract.royalties, "Contract does not support royalties");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            mimeType = mime__default["default"].getType(url);
...
var VideoPlayer = /*#__PURE__*/React__default["default"].forwardRef(function (_ref2, ref) {
  var src = _ref2.src;
      _ref2.alt;
  ...
  var _useState3 = React.useState(!requireInteraction),
...
var AudioPlayer = /*#__PURE__*/React__default["default"].forwardRef(function (_ref3, ref) {
  var src = _ref3.src;
      _ref3.alt;
...
var IframePlayer = /*#__PURE__*/React__default["default"].forwardRef(function (_ref4, ref) {
  var src = _ref4.src,
      alt = _ref4.alt,
      poster = _ref4.poster,
  ...
  var _useDimensions = useDimensions__default["default"](),
      observe = _useDimensions.observe,
      elWidth = _useDimensions.width;

  var _useState11 = React.useState(!requireInteraction),
  ...
  if (elWidth < 300) {
    return /*#__PURE__*/jsxRuntime.jsx("div", {
      ref: observe,
      children: /*#__PURE__*/jsxRuntime.jsx(LinkPlayer, _objectSpread2({
        style: style,
        src: src,
        alt: alt
      }, restProps))
...
var LinkPlayer = /*#__PURE__*/React__default["default"].forwardRef(function (_ref5, ref) {
  var src = _ref5.src,
      alt = _ref5.alt;
      _ref5.poster;
...
var MediaRenderer = /*#__PURE__*/React__default["default"].forwardRef(function (_ref6, ref) {
  _ref6.children;
      var src = _ref6.src,
      poster = _ref6.poster,
      alt = _ref6.alt,
  ...
  if (!videoOrImageSrc.mimeType) {
    return /*#__PURE__*/jsxRuntime.jsx("img", _objectSpread2(_objectSpread2({
      style: mergedStyle
    }, restProps), {}, {
      ref: ref
    }));
  } else if (videoOrImageSrc.mimeType === "text/html") {
    return /*#__PURE__*/jsxRuntime.jsx(IframePlayer, _objectSpread2({
      style: mergedStyle,
    ...
    return /*#__PURE__*/jsxRuntime.jsx(VideoPlayer, _objectSpread2({
      style: mergedStyle,
      src: videoOrImageSrc.url,
      poster: possiblePosterSrc.url,
      requireInteraction: requireInteraction
    ...
    return /*#__PURE__*/jsxRuntime.jsx(AudioPlayer, _objectSpread2({
      style: mergedStyle,
      src: videoOrImageSrc.url,
      poster: possiblePosterSrc.url,
      requireInteraction: requireInteraction
    ...
    return /*#__PURE__*/jsxRuntime.jsx("img", _objectSpread2({
      style: mergedStyle,
      src: videoOrImageSrc.url,
      alt: alt,
      ref: ref
  ...
  return /*#__PURE__*/jsxRuntime.jsx(LinkPlayer, _objectSpread2({
    style: mergedStyle,
    src: videoOrImageSrc.url,
    alt: alt,
    ref: ref
...
function useResolvedMediaType(uri) {
  var resolvedUrl = React.useMemo(function () {
    return resolveIpfsUri(uri);
  }, [uri]);
  var resolvedMimType = reactQuery.useQuery(["mime-type", resolvedUrl], function () {
 ...
 * @beta
 */
var ThirdwebNftMedia = /*#__PURE__*/React__default["default"].forwardRef(function (_ref, ref) {
  var metadata = _ref.metadata,
      props = _objectWithoutProperties(_ref, _excluded$6);

  return /*#__PURE__*/jsxRuntime.jsx(MediaRenderer, _objectSpread2({
...
function shortenAddress(address, extraShort) {
  try {
    var formattedAddress = ethers.utils.getAddress(address);
...
var Box = styled__default["default"].div(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral([""])));
...
var BaseButton = styled__default["default"].button(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n  position: relative;\n  border-radius: 0.5em;\n  padding: 0.75em 1.25em;\n  padding-right: ", ";\n  padding-left: ", ";\n  font-size: 1em;\n  font-weight: 600;\n  letter-spacing: 0.5px;\n  display: flex;\n  gap: 0.5em;\n  align-items: center;\n  color: ", ";\n  border: 2px solid\n    ", ";\n  &:hover {\n    cursor: pointer;\n  }\n  &:disabled {\n    cursor: not-allowed;\n  }\n  &:focus {\n    outline: 2px solid ", ";\n    outline-offset: 1px;\n  }\n"])), function (props) {
...
function computeHoverColor(c) {
  var col = color__default["default"](c);
...
var SolidButton = styled__default["default"](BaseButton)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  background: ", ";\n  &:hover {\n    background: ", ";\n    border-color: ", ";\n  }\n  &:disabled {\n    background: ", ";\n    border-color: ", ";\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.accent;
}, function (props) {
  return computeHoverColor(props.theme.colors.accent);
}, function (props) {
...
var OutlineButton = styled__default["default"](BaseButton)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  background: transparent;\n  &:hover {\n    background: ", ";\n  }\n"])), function (props) {
  return color__default["default"](props.theme.colors.background).alpha(0.5).hexa();
});
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Btn, _objectSpread2(_objectSpread2({}, restProps), {}, {
...
var StyledSvg = styled__default["default"].svg(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  border-radius: 0.25em;\n  flex-shrink: 0;\n  ", "\n"])), function (props) {
...
var Icon = function Icon(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StyledSvg, _objectSpread2(_objectSpread2(_objectSpread2({}, icon.svgProps), props), {}, {
    children: icon.paths
  }));
};
...
var MenuItemBase = styled__default["default"].li(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  display: flex;\n  padding: 0.75em 1em;\n  align-items: center;\n  gap: 0.5em;\n  font-size: 1em;\n\n  ", "\n\n  > svg {\n    flex-shrink: 0;\n  }\n"])), function (props) {
...
var MenuItem = function MenuItem(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(MenuItemBase, _objectSpread2(_objectSpread2({}, restProps), {}, {
...
var Menu = styled__default["default"].ul(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  padding: 0;\n  margin: 0;\n  background: ", ";\n  color: ", ";\n  outline-color: ", ";\n  outline-style: solid;\n  outline-offset: 0px;\n  list-style: none;\n  border-radius: 0.5em;\n  overflow: hidden;\n"])), function (props) {
...
var _templateObject;
var Select = styled__default["default"].select(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  margin: -0.25em 0;\n  background: ", ";\n  color: ", ";\n  border: 1px solid\n    ", ";\n  border-radius: 0.25em;\n  padding: 0.25em;\n  width: 100%;\n  flex-shrink: 1;\n  font-size: 1em;\n  &:hover {\n    cursor: pointer;\n  }\n  &:focus {\n    outline: 2px solid ", ";\n  }\n  &:disabled {\n    cursor: not-allowed;\n  }\n"])), function (props) {
  return color__default["default"](props.theme.colors.background).alpha(0.85).hexa();
}, function (props) {
  return props.theme.colors.text;
}, function (props) {
  return color__default["default"](props.theme.colors.text).alpha(0.25).hexa();
}, function (props) {
  return props.theme.colors.accent;
});
...
var SupportedNetworkSelect = function SupportedNetworkSelect(_ref) {
  ...
  var deprecatedNetworks = React.useMemo(function () {
    return sdk.SUPPORTED_CHAIN_IDS.map(function (supportedChain) {
      return getChainFromChainId(supportedChain);
    }).filter(function (n) {
      return n.id === sdk.ChainId.Rinkeby;
    });
  }, []);
  var testnets = React.useMemo(function () {
    return sdk.SUPPORTED_CHAIN_IDS.map(function (supportedChain) {
      return getChainFromChainId(supportedChain);
    }).filter(function (n) {
      return n.testnet && n.id !== sdk.ChainId.Rinkeby;
    });
  }, []);
  var mainnets = React.useMemo(function () {
    return sdk.SUPPORTED_CHAIN_IDS.map(function (supportedChain) {
      return getChainFromChainId(supportedChain);
    }).filter(function (n) {
      return !n.testnet;
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Select, _objectSpread2(_objectSpread2({}, selectProps), {}, {
...
var chainIdToCurrencyMap = (_chainIdToCurrencyMap = {}, _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Mainnet, "ethereum"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Goerli, "ethereum"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Rinkeby, "ethereum"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Arbitrum, "arbitrum"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.ArbitrumTestnet, "arbitrum"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Avalanche, "avalanche"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.AvalancheFujiTestnet, "avalanche"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Fantom, "fantom"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.FantomTestnet, "fantom"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Optimism, "optimism"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.OptimismTestnet, "optimism"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Polygon, "polygon"), _defineProperty(_chainIdToCurrencyMap, sdk.ChainId.Mumbai, "polygon"), _chainIdToCurrencyMap);
/**
...
var ConnectWallet = function ConnectWallet(_ref) {
  ...
  var mountedAddress = React.useMemo(function () {
    return isMounted ? address : null;
  }, [address, isMounted]);

  var _useMachine = react$1.useMachine(menu__namespace.machine({
    id: id,
    closeOnSelect: true,
    positioning: {
      sameWidth: true
  ...
  var api = menu__namespace.connect(state, send, react$1.normalizeProps);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ThemeProvider, _objectSpread2(_objectSpread2({}, themeProps), {}, {
    children: /*#__PURE__*/jsxRuntime.jsxs("div", {
      style: {
        position: "relative"
      },
      children: [/*#__PURE__*/jsxRuntime.jsx(Button, _objectSpread2(_objectSpread2({
        ...
        leftElement: mountedAddress && chainId && chainId in chainIdToCurrencyMap ? /*#__PURE__*/jsxRuntime.jsx(Icon, {
          boxSize: "1.5em",
          name: chainIdToCurrencyMap[chainId]
        }) : undefined,
        rightElement: /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        ...
        children: mountedAddress ? /*#__PURE__*/jsxRuntime.jsxs("span", {
          style: {
            display: "flex",
            flexDirection: "column",
            fontWeight: 400,
      ...
      })), /*#__PURE__*/jsxRuntime.jsx(portal.Portal, {
        children: /*#__PURE__*/jsxRuntime.jsx(Box, _objectSpread2(_objectSpread2({}, api.positionerProps), {}, {
          style: {
            zIndex: 9999,
            fontFamily: fontFamily
          },
          children: /*#__PURE__*/jsxRuntime.jsx(Menu, _objectSpread2(_objectSpread2({}, api.contentProps), {}, {
            children: !api.isOpen ? null : mountedAddress ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [/*#__PURE__*/jsxRuntime.jsx(MenuItem, _objectSpread2(_objectSpread2({}, api.getItemProps({
                id: "copy",
                closeOnSelect: false
              })), {}, {
              ...
              })), /*#__PURE__*/jsxRuntime.jsx(MenuItem, _objectSpread2(_objectSpread2({}, api.getItemProps({
                id: "switch-network",
                closeOnSelect: false,
              ...
              children: [supportedConnectors.findIndex(function (c) {
              ...
              }) > -1 && /*#__PURE__*/jsxRuntime.jsx(MenuItem, _objectSpread2(_objectSpread2({}, api.getItemProps({
                id: "metamask"
              })), {}, {
                ...
                return /*#__PURE__*/jsxRuntime.jsx(MenuItem, _objectSpread2(_objectSpread2({}, api.getItemProps({
                  id: c.id
                })), {}, {
...
var Web3Button = function Web3Button(_ref) {
  ...
  var switchToChainId = React.useMemo(function () {
  ...
  if (!address) {
    return /*#__PURE__*/jsxRuntime.jsx(ConnectWallet, _objectSpread2({}, themeProps));
  }
